    ...
    <div className="bg-white pt-2 pb-4" style={{ position: "relative" }}>
      ...
      <Container>
          ...
          >
            <Box
              ...
              sx={{
                ...
                mr: 2,
                filter:
                  "brightness(0.7) sepia(1) saturate(2) hue-rotate(20deg)",
              }}
            />
            <Typography
              fontWeight={600}
        ...
        <Grid item xs={12}>
          ...
          {(isRouteChanging || isApiLoading || isFetching) &&
          products.length === 0 &&
          clientPage === 1 ? (
            <Box
              sx={{
